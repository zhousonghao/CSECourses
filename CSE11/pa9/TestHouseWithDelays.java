/**
 * Program to test various Shapes per CSE 11 - Inheritance
 * homework.
 *
...
public class TestHouseWithDelays extends ActiveObject
{
  ...
  public void run()
  {
    ...
    CSE11_Line pane1 =
        new CSE11_Line( new Point( xCenter - 60, yCenter + 25 ),
                        new Point( xCenter -60, yCenter + 55 ) );
    CSE11_Line pane2 =
        new CSE11_Line( new Point( xCenter - 75, yCenter + 40 ),
    ...
    Shape newPane1 = new CSE11_Line( pane1 );	// CSE11_Line's copy ctor
    newPane1.move( 115, 0 );			// CSE11_Line's move()
    newPane1.draw( canvas, Color.BLUE, false );
    pause( DELAY );

    Shape newPane2 = new CSE11_Line( pane2 );	// CSE11_Line's copy ctor
    newPane2.move( 115, 0 );			// CSE11_Line's move()
     ...
     * Add a driveway. 
     *
     * Spell out "CSE 11" using CSE11_Line objects.
     */
  }
