 ...
 * Date: 2/4/2014 
 * File: Lamb.java 
 * Purpose: Lamb.java is the class that define for contruction of visible
 * image of Lamb and all the methods that declared in the interfaces
 */ 
import objectdraw.*;
import java.awt.*;
...
/* 
 * Name: Lamb
 * Purpose: In Lamb class. In this constructor,
 * the program creates a visible image Lamb and 2 framed rec that 
 * surround the Lamb visible image and provides all the methods that
...
private VisibleImage lamb;
private FramedRect  lamb_border1, lamb_border2 ; 
...
/* 
 * Name: Lamb
 * Purpose: This is the constructor for the Lamb class. In this constructor,
 * the program creates a visible image Lamb and 2 framed rec that 
 * surround the Lamb visible image
 * Parameters: Image pic, Location origin , DrawingCanvas canvas
 * Return: void
 */
public Lamb(Image pic, Location origin , DrawingCanvas canvas) {
	
	lamb = new VisibleImage (pic , origin.getX(), origin.getY(), canvas);

	lamb_border1 = new FramedRect ( origin.getX(), origin.getY(), 
					FRAMED_REC_WIDTH-BORDER_OFFSET, 
				FRAMED_REC_HEIGHT-BORDER_OFFSET, canvas);

	lamb_border2 = new FramedRect ( origin.getX()+BORDER_OFFSET, 
...
public void showHighlight( Color color ){
	...
	lamb_border1.setColor( color);
	lamb_border2.setColor( color);
