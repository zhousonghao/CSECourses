 ...
 * Date: 2/4/2014 
 * File: Puppy.java 
 * Purpose: Puppy.java is the class that define for contruction of visible
 * image of Puppy and all the methods that declared in the interfaces
 */
import objectdraw.*;
import java.awt.*;
...
/* 
 * Name: Puppy
 * Purpose: In Puppy class. In this constructor,
 * the program creates a visible image Puppy and 2 framed rec that 
 * surround the Puppy visible image and provides all the methods that
...
private VisibleImage puppy;
private FramedRect  puppy_border1, puppy_border2; 
...
/* 
 * Name: Puppy
 * Purpose: This is the constructor for the Puppy class. In this constructor,
 * the program creates a visible image Puppy and 2 framed rec that 
 * surround the Puppy visible image
 * Parameters: Image pic, Location origin , DrawingCanvas canvas
 * Return: void
 */
public Puppy(Image pic, Location origin , DrawingCanvas canvas) {
	
	puppy = new VisibleImage (pic , origin.getX(), origin.getY(), canvas);

	puppy_border1 = new FramedRect ( origin.getX(), origin.getY(), 
					FRAMED_REC_WIDTH-BORDER_OFFSET, 
				FRAMED_REC_HEIGHT-BORDER_OFFSET, canvas);

	puppy_border2 = new FramedRect ( origin.getX()+BORDER_OFFSET, 
...
public void showHighlight( Color color ){
	...
	puppy_border1.setColor(color);
	puppy_border2.setColor(color);
