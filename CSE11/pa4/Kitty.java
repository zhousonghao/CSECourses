 ...
 * Date: 2/4/2014 
 * File: Kitty.java 
 * Purpose: Kitty.java is the class that define for contruction of visible
 * image of Kitty and all the methods that declared in the interfaces
 */ 
import objectdraw.*;
import java.awt.*;
...
/* 
 * Name: Kitty
 * Purpose: In Kitty class. In this constructor,
 * the program creates a visible image Kitty and 2 framed rec that 
 * surround the Kitty visible image and provides all the methods that
...
private VisibleImage kitty;
private FramedRect  kitty_border1, kitty_border2;
...
/* 
 * Name: Kitty
 * Purpose: This is the constructor for the Kitty class. In this constructor,
 * the program creates a visible image Kitty and 2 framed rec that 
 * surround the Kitty visible image
 * Parameters: Image pic, Location origin , DrawingCanvas canvas
 * Return: void
 */
public Kitty(Image pic, Location origin , DrawingCanvas canvas) {
	
	kitty = new VisibleImage (pic , origin.getX(), origin.getY(), canvas);

	kitty_border1 = new FramedRect ( origin.getX(), origin.getY(), 
					FRAMED_REC_WIDTH-BORDER_OFFSET, 
				FRAMED_REC_HEIGHT-BORDER_OFFSET, canvas);

	kitty_border2 = new FramedRect ( origin.getX()+BORDER_OFFSET, 
...
public void showHighlight( Color color ){
	...
	kitty_border1.setColor( color);
	kitty_border2.setColor( color);
